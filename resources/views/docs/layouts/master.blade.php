...
<div class="hero">
    <nav class="navbar navbar-expand-md navbar-dark">
        <div class="container mt-1 mb-1">
            ...
            <a class="navbar-brand" href="{{locale_url('/')}}?utm_source=website&utm_content=docs"><img src="{{asset(config('docblog.logo'))}}" height="30" alt="{{ config('docblog.name') }}" class="d-inline-block "> {{config('docblog.name')}}</a>
