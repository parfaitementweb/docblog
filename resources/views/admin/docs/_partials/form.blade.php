...
<div class="row">
    <div class="col-md-8">
        ...
        <div class="form-group">
            ...
            <input class="form-control" id="slug" name="slug" value="{{ ($lang == $force_lang) ? old('slug', $doc->getTranslationWithoutFallback('slug', $lang)) : $doc->getTranslationWithoutFallback('slug', $lang) }}" required>
            @if($errors->has('slug'))
        ...
        <div class="form-group">
            ...
            <input class="form-control {{ ($errors->has('title')) ? 'is-invalid': ''}}" id="title" name="title" value="{{ ($lang == $force_lang) ? old('title', $doc->getTranslationWithoutFallback('title', $lang)) : $doc->getTranslationWithoutFallback('title', $lang) }}"
                   required>
            @if($errors->has('title'))
        ...
        <div class="form-group">
            ...
            <textarea class="form-control {{ ($errors->has('text')) ? 'is-invalid': ''}}" rows="50" id="text-{{$lang}}" name="text"
                      required>{{ ($lang == $force_lang) ? old('text', $doc->getTranslationWithoutFallback('text', $lang)) : $doc->getTranslationWithoutFallback('text', $lang) }}</textarea>
            @if($errors->has('text'))
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input class="form-control {{ ($errors->has('seo_title')) ? 'is-invalid': ''}}" id="seo_title" name="seo_title" placeholder="%title%"
                           value="{{ ($lang == $force_lang) ? old('seo_title', $doc->getTranslationWithoutFallback('seo_title', $lang)) : $doc->getTranslationWithoutFallback('seo_title', $lang) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ ($errors->has('seo_description')) ? 'is-invalid': ''}}" id="seo_description" placeholder="%excerpt%" name="seo_description"
                           value="{{ ($lang == $force_lang) ? old('seo_description', $doc->getTranslationWithoutFallback('seo_description', $lang)) : $doc->getTranslationWithoutFallback('seo_description', $lang) }}">
                    @if($errors->has('seo_description'))
                        <div class="invalid-feedback">{{ $errors->first('seo_description') }}</div>
                    @endif
                </div>
                <div class="form-group">
                    <label for="seo_description">Breadcrumb Title [{{strtoupper($lang)}}]</label>
                    <input class="form-control {{ ($errors->has('breadcrumb_title')) ? 'is-invalid': ''}}" id="breadcrumb_title" placeholder="%title%" name="breadcrumb_title"
                           value="{{ ($lang == $force_lang) ? old('breadcrumb_title', $doc->getTranslationWithoutFallback('breadcrumb_title', $lang)) : $doc->getTranslationWithoutFallback('breadcrumb_title', $lang) }}">
                        ...
                        <div class="card mr-3" style="max-width: 250px;">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex mt-3">
                                    ...
                                    <a onclick="return confirm('Confirm DELETE?')" href="{{action('\Parfaitementweb\DocBlog\Http\Controllers\Admin\DocsController@deleteMedia', ['doc' => $doc->id, 'media' => $media->getKey()])}}" class="card-link text-danger">Delete</a>
                                </div>
                            </div>
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            <input class="form-control" id="publish_date" name="publish_date" value="{{ old('publish_date', $doc->publish_date->format('Y-m-d H:i:s')) }}" required>
        ...
        <div class="form-group">
            ...
            <input class="form-control" id="tags" name="tags_text" value="{{ old('tags_text', $doc->tags_text) }}">
        ...
        <div class="form-group form-checkbox">
            <input class="mr-2" name="published" value="1" type="checkbox" {{ $doc->getTranslationWithoutFallback('published', $lang) ? 'checked' : '' }}> Published
        </div>
        ...
        <div class="form-group text-right">
            <a onclick="return confirm('Confirm DELETE?')" href="{{ action('\Parfaitementweb\DocBlog\Http\Controllers\Admin\DocsController@forget', ['doc' => $doc->id, 'lang' => $lang]) }}" class="btn btn-danger btn-sm">Delete
